...
4. **短期促销价忽略，记录正价（list price）**：划线价、限时折扣、促销期特价一律不采；表格要的是稳定可比的正价。永久折扣若以划线价形式呈现，同样取未划线的正价并在 selection_note 说明
...
- **划线价 vs 生效价**：MiniMax 显示 ~~$0.60~~ $0.30（永久 5 折）——取**未划线的正价**（规则 4），selection_note 注明折扣存在
- **促销期价格**：Gemini 3.7 Flash 促销到 2026-12-31，之后翻倍——按规则 4 取正价（促销结束后的价格），促销价忽略
