...
- **模型版本代替规则**：同一厂商的同一产品线出现更新版本时（如 Gemini 3.7 Flash → Gemini 3.8 Flash、Claude Opus 5 → Opus 5.5），**新版本代替旧版本**，旧版本从列表移除。只有**全新产品线**的模型才追加（如 GPT 5.6 系列之外新增 GPT 6 Astra 系列）
